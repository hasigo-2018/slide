...
ターゲットの年齢層、職業、ライフスタイルを3つのペルソナで提案してください
            ...
            <button class="copy-btn" onclick="copyPrompt('prompt-gemini-1')">
                <i class="fas fa-copy"></i> コピー
            </button>
        </div>
...
3. 各提案の理由
            ...
            <button class="copy-btn" onclick="copyPrompt('prompt-gemini-2')">
                <i class="fas fa-copy"></i> コピー
            </button>
        </div>
...
--ar 16:9
            ...
            <button class="copy-btn" onclick="copyPrompt('prompt-flux-1')">
                <i class="fas fa-copy"></i> コピー
            </button>
        </div>
